...
if __name__ == "__main__":
    num_of_models = int(input("How many models to sample?"))
    ...
    new_params_list = random.sample(params_list, min(num_of_models, len(params_list)))
    print("sampled models are")
    print(new_params_list)
    print("running models")
    run_model_with_grid_search(results_dir, docs,
                               filenames_lst, corpus, dictionary, new_params_list)
